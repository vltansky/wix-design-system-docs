...
### enableSearch
- type: bool
- description: Sets whether to enable search in the dropdown
### emptyStateMessage
- type: string
...
- type: func
- description: Defines a callback function to get the text for the selected options
### ariaControls
- type: string
...
### delimiter
- type: string
- description: Specifies the delimiter symbol to be displayed between the selected options in the input
### disabled
- type: bool
...
### onDeselect
- type: func
- description: Defines a callback function called on option deselect. Function receives the id of the unselected option as the first argument, and the actual option object as the second argument.
### onEnterPressed
- type: func
...
### popoverProps
- type: shape
- description: Allows to pass all common popover props. Check `&lt;Popover/&gt;` API for a full list.
### prefix
- type: node
...
### selectedOptions
- type: array
- description: Specifies an array of selected options ids
...
### type
- type: string
- description: Specifies the type of `&lt;input&gt;` element to display. Default type is text.
### value
- type: union
...
### disableEditing
- type: bool
- description: Specifies if the input can be edited
### clearOnBlur
- type: any
- description: No description
